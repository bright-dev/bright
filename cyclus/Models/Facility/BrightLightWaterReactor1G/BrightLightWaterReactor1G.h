...
/**
   @class BrightLightWaterReactor 
   This FacilityModel represents a reactor using predefined fresh and 
   spent fuel recipes. 
    
   The BrightLightWaterReactor class inherits from the FacilityModel class and is 
   ...
   The BrightLightWaterReactorFacility is a facility type in *Cyclus* which 
   ...
   BrightLightWaterReactorFacility generates spentFuel, then offers that material 
   ...
   BrightLightWaterReactorFacility behavior is fully defined by the following 
   parameters:  
   ...
   BrightLightWaterReactorFacility behavior may also be specified with the 
   ...
   The BrightLightWaterReactorFacility starts operation when the simulation 
   ...
   the BrightLightWaterReactorFacility adds the amount it has produced to its 
   ...
   request, the BrightLightWaterReactorFacility executes that order by subtracting 
   ...
   If the stocks are empty, the BrightLightWaterReactor asks for a batch. 
   The BrightLightWaterReactor offers anything in the inventory. 
   ...
   The BrightLightWaterReactor puts the material it receives in the stocks. 
   ...
   BrightLightWaterReactorFacility offers an infinite amount of material to the 
   appropriate market. If there is a request for that material, the 
   BrightLightWaterReactorFacility executes that order by sending that amount to 
...
class BrightLightWaterReactor : public FacilityModel  {
 public:  
  BrightLightWaterReactor();
  virtual ~BrightLightWaterReactor() {};
  ...
  virtual void copy(BrightLightWaterReactor* src);
  ...
  /**
     The handleTick function specific to the BrightLightWaterReactor. 
  ...
  /// The BrightLightWaterReactor reports a power capacity of its capacity factor   
 ...
 private:
  ...
  /**
     The BrightLightWaterReactor has a limit to how material it can process. 
  ...
  /**
     ...
     grow to. The BrightLightWaterReactor must stop processing the material in its 
