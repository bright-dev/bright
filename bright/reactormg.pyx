...
cdef class ReactorMG(fccomp.FCComp):
    ...
    def _reactormg_reactormg_0(self, n=""):
        ...
        cdef char * n_proxy
        n_bytes = n.encode()
        self._inst = new cpp_reactormg.ReactorMG(std_string(<char *> n_bytes))
    ...
    def _reactormg_reactormg_1(self, paramtrack, n=""):
        ...
        n_bytes = n.encode()
        self._inst = new cpp_reactormg.ReactorMG(paramtrack_proxy.set_ptr[0], std_string(<char *> n_bytes))
    ...
    def _reactormg_reactormg_2(self, rp, n=""):
        ...
        n_bytes = n.encode()
        self._inst = new cpp_reactormg.ReactorMG((<cpp_reactor_parameters.ReactorParameters *> rp_proxy._inst)[0], std_string(<char *> n_bytes))
    ...
    def _reactormg_reactormg_3(self, rp, paramtrack, n=""):
        ...
        paramtrack_proxy = pyne.stlcontainers.SetStr(paramtrack, not isinstance(paramtrack, pyne.stlcontainers._SetStr))
        n_bytes = n.encode()
        self._inst = new cpp_reactormg.ReactorMG((<cpp_reactor_parameters.ReactorParameters *> rp_proxy._inst)[0], paramtrack_proxy.set_ptr[0], std_string(<char *> n_bytes))
    ...
    property burnup_via_constant:
        ...
        def __get__(self):
            return bytes(<char *> (<cpp_reactormg.ReactorMG *> self._inst).burnup_via_constant.c_str()).decode()
    
        def __set__(self, value):
            cdef char * value_proxy
            value_bytes = value.encode()
            (<cpp_reactormg.ReactorMG *> self._inst).burnup_via_constant = std_string(<char *> value_bytes)
    ...
    property lattice_flag:
        ...
        def __get__(self):
            return bytes(<char *> (<cpp_reactormg.ReactorMG *> self._inst).lattice_flag.c_str()).decode()
    
        def __set__(self, value):
            cdef char * value_proxy
            value_bytes = value.encode()
            (<cpp_reactormg.ReactorMG *> self._inst).lattice_flag = std_string(<char *> value_bytes)
    
    
    property libfile:
        """The path (str) to the reactor data library; usually something like "lwr_mg.h5"."""
        def __get__(self):
            return bytes(<char *> (<cpp_reactormg.ReactorMG *> self._inst).libfile.c_str()).decode()
    
        def __set__(self, value):
            cdef char * value_proxy
            value_bytes = value.encode()
            (<cpp_reactormg.ReactorMG *> self._inst).libfile = std_string(<char *> value_bytes)
    ...
    def loadlib(self, lib="Reactor.h5"):
        ...
        (<cpp_reactormg.ReactorMG *> self._inst).loadlib(std_string(<char *> lib_bytes))
