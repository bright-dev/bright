...
cdef class FuelFabrication(fccomp.FCComp):
    ...
    def _fuelfabrication_fuelfabrication_0(self, mats, mws_in, r, n=""):
        ...
        n_bytes = n.encode()
        self._inst = new cpp_fuel_fabrication.FuelFabrication(mats_proxy.map_ptr[0], mws_in_proxy.map_ptr[0], (<cpp_reactor1g.Reactor1G *> r_proxy._inst)[0], std_string(<char *> n_bytes))
    ...
    def _fuelfabrication_fuelfabrication_1(self, mats, mws_in, r, paramtrack, n=""):
        ...
        n_bytes = n.encode()
        self._inst = new cpp_fuel_fabrication.FuelFabrication(mats_proxy.map_ptr[0], mws_in_proxy.map_ptr[0], (<cpp_reactor1g.Reactor1G *> r_proxy._inst)[0], paramtrack_proxy.set_ptr[0], std_string(<char *> n_bytes))
    ...
    def _fuelfabrication_fuelfabrication_2(self, n=""):
        ...
        cdef char * n_proxy
        n_bytes = n.encode()
        self._inst = new cpp_fuel_fabrication.FuelFabrication(std_string(<char *> n_bytes))
    ...
    def _fuelfabrication_fuelfabrication_3(self, paramtrack, n=""):
        ...
        paramtrack_proxy = pyne.stlcontainers.SetStr(paramtrack, not isinstance(paramtrack, pyne.stlcontainers._SetStr))
        n_bytes = n.encode()
        self._inst = new cpp_fuel_fabrication.FuelFabrication(paramtrack_proxy.set_ptr[0], std_string(<char *> n_bytes))
