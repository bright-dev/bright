...
cdef class EnrichmentParameters:
    ...
    property j:
        ...
        """
        def __get__(self):
            return nucname.zzaaam((<cpp_enrichment_parameters.EnrichmentParameters *> self._inst).j)
    ...
    property k:
        ...
        """
        def __get__(self):
            return nucname.zzaaam((<cpp_enrichment_parameters.EnrichmentParameters *> self._inst).k)
