...
cdef class ReactorParameters:
    ...
    property burnup_via_constant:
        ...
        def __get__(self):
            return bytes(<char *> (<cpp_reactor_parameters.ReactorParameters *> self._inst).burnup_via_constant.c_str()).decode()
    
        def __set__(self, value):
            cdef char * value_proxy
            value_bytes = value.encode()
            (<cpp_reactor_parameters.ReactorParameters *> self._inst).burnup_via_constant = std_string(<char *> value_bytes)
    ...
    property lattice_type:
        ...
        def __get__(self):
            return bytes(<char *> (<cpp_reactor_parameters.ReactorParameters *> self._inst).lattice_type.c_str()).decode()
    
        def __set__(self, value):
            cdef char * value_proxy
            value_bytes = value.encode()
            (<cpp_reactor_parameters.ReactorParameters *> self._inst).lattice_type = std_string(<char *> value_bytes)
