...
cdef class Enrichment(fccomp.FCComp):
    ...
    def _enrichment_enrichment_0(self, ep, n=""):
        ...
        n_bytes = n.encode()
        self._inst = new cpp_enrichment.Enrichment((<cpp_enrichment_parameters.EnrichmentParameters *> ep_proxy._inst)[0], std_string(<char *> n_bytes))
    ...
    def _enrichment_enrichment_1(self, n=""):
        ...
        cdef char * n_proxy
        n_bytes = n.encode()
        self._inst = new cpp_enrichment.Enrichment(std_string(<char *> n_bytes))
    ...
    property j:
        ...
        """
        def __get__(self):
            return nucname.zzaaam((<cpp_enrichment.Enrichment *> self._inst).j)
    ...
    property k:
        ...
        """
        def __get__(self):
            return nucname.zzaaam((<cpp_enrichment.Enrichment *> self._inst).k)
