/* Generated by Cython 0.14.1rc3 on Sat Feb 19 12:32:07 2011 */
 ...
 * 
 */
    __pyx_t_1 = ((PyObject *)__pyx_f_13stlconverters_vector_to_array_1d_dbl((*__pyx_v_mapiter).second)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 200; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_3 = (*__pyx_v_mapiter).first;
    if (__Pyx_SetItemInt(((PyObject *)__pyx_v_pydict), __pyx_t_3, __pyx_t_1, sizeof(int), PyInt_FromLong) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 200; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
