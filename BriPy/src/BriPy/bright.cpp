/* Generated by Cython 0.14.1rc3 on Fri Feb 11 13:18:27 2011 */
...
static PyObject *__pyx_pf_5BriPy_10Enrichment_3doCalc(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_5BriPy_10Enrichment_3doCalc[] = "This method performs an optimization calculation on M* and solves for \n        appropriate values for all Enrichment attributes.  This includes the \n        product and waste streams flowing out of the the cascade as well.\n\n        Args:\n            * input (dict or MassStream or None): If input is present, it is set as the component's \n            IsosIn.  If input is a isotopic dictionary (zzaaam keys, float values), this dictionary \n            is first converted into a MassStream before being set as IsosIn.\n\n        Returns:\n            * output (MassStream): IsosOut.\n\n        ";
static PyObject *__pyx_pf_5BriPy_10Enrichment_3doCalc(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "doCalc") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 717; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("doCalc", 0, 0, 1, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 717; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
 ...
 *         if input is None:
 */
  __pyx_t_1 = PyObject_Call(((PyObject *)((PyObject*)__pyx_ptype_11mass_stream_MassStream)), ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 732; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/home/scopatz/bright/BriPy/src/BriPy/bright_wrapper.pyx":735
 * 
 *         if input is None:
 *             output.ms_pointer[0] = (<cpp_bright.FCComp *> self.e_pointer).doCalc()             # <<<<<<<<<<<<<<
 *         elif isinstance(input, dict):
 ...
 *             in_ms = input
 */
    if (!(likely(PyDict_CheckExact(__pyx_v_input))||((__pyx_v_input) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected dict, got %.200s", Py_TYPE(__pyx_v_input)->tp_name), 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 737; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "/home/scopatz/bright/BriPy/src/BriPy/bright_wrapper.pyx":738
 *         elif isinstance(input, dict):
 *             output.ms_pointer[0] = self.e_pointer.doCalc(conv.dict_to_map_int_dbl(input))
 *         elif isinstance(input, mass_stream.MassStream):             # <<<<<<<<<<<<<<
 *             in_ms = input
 ...
 * 
 */
    if (!(likely(((__pyx_v_input) == Py_None) || likely(__Pyx_TypeTest(__pyx_v_input, __pyx_ptype_11mass_stream_MassStream))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 739; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  /* "/home/scopatz/bright/BriPy/src/BriPy/bright_wrapper.pyx":742
 *             output.ms_pointer[0] = self.e_pointer.doCalc(<cpp_mass_stream.MassStream> in_ms.ms_pointer[0])
 * 
 *         return output             # <<<<<<<<<<<<<<
 */
...
static PyMethodDef __pyx_methods_5BriPy_Enrichment[] = {
  ...
  {__Pyx_NAMESTR("doCalc"), (PyCFunction)__pyx_pf_5BriPy_10Enrichment_3doCalc, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_5BriPy_10Enrichment_3doCalc)},
  {0, 0, 0, 0}
};
