/* Generated by Cython 0.14.1rc3 on Sat Feb 19 13:09:05 2011 */
...
/* "/home/scopatz/bright/BriPy/src/BriPy/bright_wrapper.pyx":1815
 * 
 *     property name:
 *         def __get__(self):             # <<<<<<<<<<<<<<
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = PyBytes_FromString(__pyx_v_n.c_str()); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1817; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(((PyObject *)__pyx_t_1));
  __pyx_r = ((PyObject *)__pyx_t_1);
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "/home/scopatz/bright/BriPy/src/BriPy/bright_wrapper.pyx":1819
 *             return n.c_str()
 * 
 *         def __set__(self, char * n):             # <<<<<<<<<<<<<<
...
static int __pyx_pf_5BriPy_9Reactor1G_4name_1__set__(PyObject *__pyx_v_self, PyObject *__pyx_arg_n) {
  ...
  __Pyx_RefNannySetupContext("__set__");
  assert(__pyx_arg_n); {
    __pyx_v_n = PyBytes_AsString(__pyx_arg_n); if (unlikely((!__pyx_v_n) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1819; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  ...
  /* "/home/scopatz/bright/BriPy/src/BriPy/bright_wrapper.pyx":1820
 * 
 *         def __set__(self, char * n):
 *             self.r1g_pointer.name = std.string(n)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/scopatz/bright/BriPy/src/BriPy/bright_wrapper.pyx":1826
 *         def __get__(self):
 *             cdef std.string n = self.r1g_pointer.natural_name
 *             return n.c_str()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = PyBytes_FromString(__pyx_v_n.c_str()); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1826; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(((PyObject *)__pyx_t_1));
  __pyx_r = ((PyObject *)__pyx_t_1);
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "/home/scopatz/bright/BriPy/src/BriPy/bright_wrapper.pyx":1828
 *             return n.c_str()
 * 
 *         def __set__(self, char * n):             # <<<<<<<<<<<<<<
...
static int __pyx_pf_5BriPy_9Reactor1G_12natural_name_1__set__(PyObject *__pyx_v_self, PyObject *__pyx_arg_n) {
  ...
  __Pyx_RefNannySetupContext("__set__");
  assert(__pyx_arg_n); {
    __pyx_v_n = PyBytes_AsString(__pyx_arg_n); if (unlikely((!__pyx_v_n) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1828; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_5BriPy_9Reactor1G_6IsosIn___get__(PyObject *__pyx_v_self) {
  ...
  /* "/home/scopatz/bright/BriPy/src/BriPy/bright_wrapper.pyx":1834
 *     property IsosIn:
 *         def __get__(self):
 *             cdef mass_stream.MassStream py_ms = mass_stream.MassStream()             # <<<<<<<<<<<<<<
 *             py_ms.ms_pointer[0] = self.r1g_pointer.IsosIn
 *             return py_ms
 */
  __pyx_t_1 = PyObject_Call(((PyObject *)((PyObject*)__pyx_ptype_11mass_stream_MassStream)), ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1834; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_py_ms = ((struct __pyx_obj_11mass_stream_MassStream *)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "/home/scopatz/bright/BriPy/src/BriPy/bright_wrapper.pyx":1835
 *         def __get__(self):
 *             cdef mass_stream.MassStream py_ms = mass_stream.MassStream()
 *             py_ms.ms_pointer[0] = self.r1g_pointer.IsosIn             # <<<<<<<<<<<<<<
 *             return py_ms
 ...
 */
  ...
  /* "/home/scopatz/bright/BriPy/src/BriPy/bright_wrapper.pyx":1836
 *             cdef mass_stream.MassStream py_ms = mass_stream.MassStream()
 *             py_ms.ms_pointer[0] = self.r1g_pointer.IsosIn
 *             return py_ms             # <<<<<<<<<<<<<<
 * 
...
static int __pyx_pf_5BriPy_9Reactor1G_6IsosIn_1__set__(PyObject *__pyx_v_self, PyObject *__pyx_v_ms) {
  int __pyx_r;
  __Pyx_RefNannySetupContext("__set__");
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_ms), __pyx_ptype_11mass_stream_MassStream, 1, "ms", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1838; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "/home/scopatz/bright/BriPy/src/BriPy/bright_wrapper.pyx":1839
 * 
 *         def __set__(self, mass_stream.MassStream ms):
 *             self.r1g_pointer.IsosIn = <cpp_mass_stream.MassStream> ms.ms_pointer[0]             # <<<<<<<<<<<<<<
 * 
...
/* "/home/scopatz/bright/BriPy/src/BriPy/bright_wrapper.pyx":1843
 * 
 *     property IsosOut:
 *         def __get__(self):             # <<<<<<<<<<<<<<
 *             cdef mass_stream.MassStream py_ms = mass_stream.MassStream()
...
static PyObject *__pyx_pf_5BriPy_9Reactor1G_7IsosOut___get__(PyObject *__pyx_v_self) {
  ...
  /* "/home/scopatz/bright/BriPy/src/BriPy/bright_wrapper.pyx":1844
 *     property IsosOut:
 *         def __get__(self):
 *             cdef mass_stream.MassStream py_ms = mass_stream.MassStream()             # <<<<<<<<<<<<<<
 *             py_ms.ms_pointer[0] = self.r1g_pointer.IsosOut
 *             return py_ms
 */
  __pyx_t_1 = PyObject_Call(((PyObject *)((PyObject*)__pyx_ptype_11mass_stream_MassStream)), ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1844; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_py_ms = ((struct __pyx_obj_11mass_stream_MassStream *)__pyx_t_1);
  __pyx_t_1 = 0;
...
static int __pyx_pf_5BriPy_9Reactor1G_7IsosOut_1__set__(PyObject *__pyx_v_self, PyObject *__pyx_v_ms) {
  int __pyx_r;
  __Pyx_RefNannySetupContext("__set__");
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_ms), __pyx_ptype_11mass_stream_MassStream, 1, "ms", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1848; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = ((PyObject *)__pyx_f_13stlconverters_map_to_dict_str_dbl(((struct __pyx_obj_5BriPy_Reactor1G *)__pyx_v_self)->r1g_pointer->ParamsIn)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1854; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static int __pyx_pf_5BriPy_9Reactor1G_8ParamsIn_1__set__(PyObject *__pyx_v_self, PyObject *__pyx_v_pi) {
  int __pyx_r;
  __Pyx_RefNannySetupContext("__set__");
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_pi), (&PyDict_Type), 1, "pi", 1))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1856; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = ((PyObject *)__pyx_f_13stlconverters_map_to_dict_str_dbl(((struct __pyx_obj_5BriPy_Reactor1G *)__pyx_v_self)->r1g_pointer->ParamsOut)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1862; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static int __pyx_pf_5BriPy_9Reactor1G_9ParamsOut_1__set__(PyObject *__pyx_v_self, PyObject *__pyx_v_po) {
  int __pyx_r;
  __Pyx_RefNannySetupContext("__set__");
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_po), (&PyDict_Type), 1, "po", 1))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1864; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = PyInt_FromLong(((struct __pyx_obj_5BriPy_Reactor1G *)__pyx_v_self)->r1g_pointer->PassNum); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1870; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static int __pyx_pf_5BriPy_9Reactor1G_7PassNum_1__set__(PyObject *__pyx_v_self, PyObject *__pyx_arg_pn) {
  ...
  __Pyx_RefNannySetupContext("__set__");
  assert(__pyx_arg_pn); {
    __pyx_v_pn = __Pyx_PyInt_AsInt(__pyx_arg_pn); if (unlikely((__pyx_v_pn == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1872; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = ((PyObject *)__pyx_f_13stlconverters_cpp_to_py_set_str(((struct __pyx_obj_5BriPy_Reactor1G *)__pyx_v_self)->r1g_pointer->params2track)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1878; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static int __pyx_pf_5BriPy_9Reactor1G_12params2track_1__set__(PyObject *__pyx_v_self, PyObject *__pyx_v_p2t) {
  int __pyx_r;
  __Pyx_RefNannySetupContext("__set__");
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_p2t), (&PySet_Type), 1, "p2t", 1))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1880; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyObject *__pyx_pf_5BriPy_9Reactor1G_2loadLib(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "loadLib") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1888; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    if (values[0]) {
      __pyx_v_libfile = PyBytes_AsString(values[0]); if (unlikely((!__pyx_v_libfile) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1888; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
    ...
    __pyx_v_libfile = ((char *)__pyx_k_10);
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      case  1: __pyx_v_libfile = PyBytes_AsString(PyTuple_GET_ITEM(__pyx_args, 0)); if (unlikely((!__pyx_v_libfile) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1888; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      case  0: break;
      default: goto __pyx_L5_argtuple_error;
    }
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("loadLib", 0, 0, 1, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1888; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
