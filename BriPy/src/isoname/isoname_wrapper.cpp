/* Generated by Cython 0.14.1rc3 on Sun Feb  6 22:29:00 2011 */
...
static PyObject *__pyx_pf_7isoname_1zzaaam_2_MCNP(PyObject *__pyx_self, PyObject *__pyx_arg_nuc); /*proto*/
static PyMethodDef __pyx_mdef_7isoname_1zzaaam_2_MCNP = {__Pyx_NAMESTR("zzaaam_2_MCNP"), (PyCFunction)__pyx_pf_7isoname_1zzaaam_2_MCNP, METH_O, __Pyx_DOCSTR(0)};
static PyObject *__pyx_pf_7isoname_1zzaaam_2_MCNP(PyObject *__pyx_self, PyObject *__pyx_arg_nuc) {
  int __pyx_v_nuc;
  PyObject *__pyx_r = NULL;
  ...
  assert(__pyx_arg_nuc); {
    __pyx_v_nuc = __Pyx_PyInt_AsInt(__pyx_arg_nuc); if (unlikely((__pyx_v_nuc == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = PyInt_FromLong(isoname::zzaaam_2_MCNP(__pyx_v_nuc)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     cdef std.string cpp_CurrentForm
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7isoname_CurrentForm, NULL, __pyx_n_s__isoname); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__CurrentForm, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7isoname_1zzaaam_2_MCNP, NULL, __pyx_n_s__isoname); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__zzaaam_2_MCNP, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
