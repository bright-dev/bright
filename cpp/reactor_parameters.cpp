...
bright::ReactorParameters::ReactorParameters()
{
  batches = 0;
  flux = 0.0;
...
bright::ReactorParameters bright::fill_lwr_defaults ()
{
...
bright::ReactorParameters bright::lwr_defaults (bright::fill_lwr_defaults());



// Fast Reactor Defaults

bright::ReactorParameters bright::fill_fr_defaults ()
{
...
bright::ReactorParameters bright::fr_defaults (bright::fill_fr_defaults());
