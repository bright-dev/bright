...
def update_env_for_execution(env):
    ...
    if hasattr(env, 'sensitivity_mass_fractions'):
    ...
    for var in env.__dict__:
        ...
        env_initial_iso = getattr(env, var)
    ...
    env.initial_iso_vars = initial_iso_vars
    ...
    env.perturbation_params.extend(initial_iso_vars)
 
    env.perturbation_params.append('burn_times')   # burn_times needs to be the last element
