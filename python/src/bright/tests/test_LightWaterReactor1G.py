...
class TestLightWaterReactor1GMethods(TestCase):
    ...
    def test_setParams(self):
        ...
        assert_equal(lwr.params_after_calc["U"], lwr.OutU.mass)
        assert_equal(lwr.params_prior_calc["TRU"],  lwr.InTRU.mass)
        assert_equal(lwr.params_after_calc["TRU"], lwr.OutTRU.mass)
        assert_equal(lwr.params_prior_calc["ACT"],  lwr.InACT.mass)
        assert_equal(lwr.params_after_calc["ACT"], lwr.OutACT.mass)
        assert_equal(lwr.params_prior_calc["LAN"],  lwr.InLAN.mass)
        assert_equal(lwr.params_after_calc["LAN"], lwr.OutLAN.mass)
        assert_equal(lwr.params_prior_calc["FP"],  1.0 - lwr.InACT.mass - lwr.InLAN.mass)
        assert_equal(lwr.params_after_calc["FP"], 1.0 - lwr.OutACT.mass - lwr.OutLAN.mass)
