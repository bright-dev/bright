/* Generated by Cython 0.14.1rc3 on Sat Mar  5 22:20:28 2011 */
...
static std::map<int,std::vector<std::vector<double> > > (*__pyx_f_13stlconverters_dict_to_map_int_vector_to_array_2d_dbl)(PyObject *); /*proto*/
static PyObject *(*__pyx_f_13stlconverters_map_to_dict_int_array_to_vector_2d_dbl)(std::map<int,std::vector<std::vector<double> > >); /*proto*/
static std::map<int,std::vector<std::vector<std::vector<double> > > > (*__pyx_f_13stlconverters_dict_to_map_int_vector_to_array_3d_dbl)(PyObject *); /*proto*/
static PyObject *(*__pyx_f_13stlconverters_map_to_dict_int_array_to_vector_3d_dbl)(std::map<int,std::vector<std::vector<std::vector<double> > > >); /*proto*/
...
#endif
{
  ...
  if (__Pyx_ImportFunction(__pyx_t_1, "dict_to_map_int_vector_to_array_2d_dbl", (void (**)(void))&__pyx_f_13stlconverters_dict_to_map_int_vector_to_array_2d_dbl, "std::map<int,std::vector<std::vector<double> > > (PyObject *)") < 0) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ImportFunction(__pyx_t_1, "map_to_dict_int_array_to_vector_2d_dbl", (void (**)(void))&__pyx_f_13stlconverters_map_to_dict_int_array_to_vector_2d_dbl, "PyObject *(std::map<int,std::vector<std::vector<double> > >)") < 0) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ImportFunction(__pyx_t_1, "dict_to_map_int_vector_to_array_3d_dbl", (void (**)(void))&__pyx_f_13stlconverters_dict_to_map_int_vector_to_array_3d_dbl, "std::map<int,std::vector<std::vector<std::vector<double> > > > (PyObject *)") < 0) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ImportFunction(__pyx_t_1, "map_to_dict_int_array_to_vector_3d_dbl", (void (**)(void))&__pyx_f_13stlconverters_map_to_dict_int_array_to_vector_3d_dbl, "PyObject *(std::map<int,std::vector<std::vector<std::vector<double> > > >)") < 0) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
