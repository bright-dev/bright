...
def LightWaterReactor(IsosIn, burnup, batches, radius, length, flux,
                    ...
                    hydrogen_rescale, lattice_type, open_slots, total_slots,
                    name):
    """Light Water Reactor:  
    --------------------
    This is a light water reactor object.
    """
    _init_comp()
    ...
    params.flux = flux
    params.FuelDensity = fuel_density
    params.CoolantDensity = coolant_density
    params.pnl = pnl
    params.useDisadvantage = use_disadvantage
    params.HygrogenRescale = hydrogen_rescale
    params.LatticeType = lattice_type
